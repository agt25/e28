                ...
                <div class='col-12 col-md-8 col-lg-6'>
                    ...
                    <div class='col-12 col-md-8 col-lg-6' id='ambience-div'>
                       ...
                       <div class='row sounds'>
                        ...
                        <source src="../../assets/sounds/indoor.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/outdoor.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/evening.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/day.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/travel.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/lofi.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
                        ...
                        <source src="../../assets/sounds/moody.mp3" type="audio/mpeg">
                        Your browser does not support the audio element.  
                        </audio>
    ...
    methods: {
        ...
        */ 
        ...
        announceFave() {
          ...
          CoffeePod's $emitted message — despite having a v-on action configured on the router. 
